  ...
  switch (action.type) {
    case "INC_CURRENT_DATE_MONTH": {
      ...
      return {
        ...
        startOfMonth: moment(newDate)
          .startOf("month")
          .format("YYYY-MM-DD hh:mm"),
        endOfMonth: moment(newDate)
          .endOf("month")
          .format("YYYY-MM-DD hh:mm"),
      }
    }
    case "DEC_CURRENT_DATE_MONTH": {
      return {
        ...
        currentDate: moment(state.currentDate)
          .add(-1, "M")
          .format("YYYY-MM-DD hh:mm"),
        currentMonth: moment(state.currentDate)
          .add(-1, "M")
          .format("MMMM"),
        currentYear: moment(state.currentDate)
          .add(-1, "M")
          .format("YYYY"),
        startOfMonth: moment(state.currentDate)
          .add(-1, "M")
          .startOf("month")
          .format("YYYY-MM-DD hh:mm"),
        endOfMonth: moment(state.currentDate)
          .add(-1, "M")
          .endOf("month")
          .format("YYYY-MM-DD hh:mm"),
      }
