...
const createDynamicMuiTheme = (settings) => {
  ...
  let PrimaryColorMain = "#d81b60",
    PrimaryColorLight = "#ff5c8d",
    PrimaryColorDark = "#d81b60",
    PrimaryContrastText = "#FFF",
    SecondaryColorMain = "#512ca8",
    SecondaryColorLight = "#8558da",
  ...
  if (PCLight) {
    PrimaryColorLight = `#${PCLight}`
  }
  if (PCDark) {
    PrimaryColorDark = `#${PCDark}`
  }
  if (SCMain) {
    SecondaryColorMain = `#${SCMain}`
  }
  if (SCLight) {
    SecondaryColorLight = `#${SCLight}`
  }
  if (SCDark) {
    SecondaryColorDark = `#${SCDark}`
  }
  if (PCContrast) {
    PrimaryContrastText = `#${PCContrast}`
  }
  if (SCContrast) {
    SecondaryContrastText = `#${SCContrast}`
  }
...
export default createDynamicMuiTheme;