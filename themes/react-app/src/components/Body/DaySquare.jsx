  ...
  render() {
    ...
    return (
      <div className={this.props.className}>
        ...
        <span className={isToday ? classes.isTodayNumber : classes.dayNumber}>
...
const reduxWrapper = connect(
  (state, ownProps) => ({
    daysEvents: R.pathOr(
      [],
      [ownProps.year, ownProps.month, ownProps.day, "data"],
      state.event.visibleEvents
    ),
